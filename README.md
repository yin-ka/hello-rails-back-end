...
```sh
  cd my-folder
  git clone git@github.com:yin-ka/Hello-rails-react.git
```
--->
### Install
...
Feel free to check the [Issues](https://github.com/yin-ka/hello-rails-back-end/issues).
<p align="right">(<a href="#readme-top">back to top</a>)</p>
<!-- SUPPORT -->
...
This project is [MIT](https://github.com/yin-ka/hello-rails-back-end/blob/dev/LICENSE) licensed.
